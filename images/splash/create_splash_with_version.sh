...
if [ ! -f ./images/splash/_splash_without_version.png ]; then
  ...
  magick -pointsize 36 -font "./images/splash/google_fonts_montserrat_italic.ttf" "./images/temp.mpc" -gravity SouthWest -fill "#aaaaaa" -annotate +10+5 "DiffusionBee 2.5.3 (FLUX.1-dev + Real-ESRGAN)" "./images/splash/_splash_without_version.png"
fi

# --- add version info ---
magick -pointsize 128 -font "./images/splash/google_fonts_montserrat_bold.ttf" "./images/splash/_splash_without_version.png" -gravity West -fill "black" -annotate +1403+563 "${DISPLAY_VERSION}" "./images/temp.mpc"
