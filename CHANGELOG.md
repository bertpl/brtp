...
- **improved**:
  - CI: make pipeline more efficient by improving parallelization of jobs (squashing)
...
- **improved**:
  - reduce hard-coded constants in GH actions
...
- **improved**:
  - further fixes to release process
...
- **improved**:
  - fix issue with release process - push tag with PAT token
